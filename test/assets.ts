...
export const INSTANTCOIN = new Asset({
    ...
    reissuable: true,
    precision: 2,
    description: 'INSTANTCOIN a token that is been build on the DCC platform. Subscribe on the website & social media for more upcoming updates.',
    height: 851542
});
